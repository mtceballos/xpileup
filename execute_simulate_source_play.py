...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
            description='Execute the jupyter notebook for source spectral simulation',
            prog='execute_simulate_source_play.py')
    ...
    nbname=f'./output_ipynb/output_{model}_{flux_mcrab}_{Emin}_{Emax}_{filter}_{focus}_sim{sim_number}_play.ipynb'
    ...
    pm.execute_notebook(
        'simulate_source_play.ipynb', nbname,
